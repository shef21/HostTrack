...
sw_lat = -33.9950  # South-West latitude
sw_long = 18.4550  # South-West longitude
zoom_value = 14  # Zoom level for detailed view

try:
    # Search listings
    print("Searching for listings in Claremont...")
    ...
    # Save raw data
    with open('airbnb_claremont_limited.json', 'w', encoding='utf-8') as f:
        json.dump(limited_results, f, indent=2, ensure_ascii=False)
    print("Raw results saved to airbnb_claremont_limited.json")
