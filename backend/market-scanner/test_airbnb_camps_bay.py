...
try:
    ...
    # Save raw data
    with open('airbnb_camps_bay_limited.json', 'w', encoding='utf-8') as f:
        json.dump(limited_results, f, indent=2, ensure_ascii=False)
    print("Raw results saved to airbnb_camps_bay_limited.json")
