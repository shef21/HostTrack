...
async function saveAirbnbData() {
    try {
        ...
        const rawData = JSON.parse(fs.readFileSync('airbnb_observatory_limited.json', 'utf8'));
...
async function saveBookingData() {
    try {
        ...
        const rawData = JSON.parse(fs.readFileSync('booking_observatory_raw.json', 'utf8'));
