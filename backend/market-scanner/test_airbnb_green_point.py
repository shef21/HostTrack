...
ne_long = 18.4100  # North-East longitude
sw_lat = -33.9200  # South-West latitude
sw_long = 18.3900  # South-West longitude
zoom_value = 14  # Zoom level for detailed view

try:
    # Search listings
    print("Searching for listings in Green Point...")
    ...
    # Save raw data
    with open('airbnb_green_point_limited.json', 'w', encoding='utf-8') as f:
        json.dump(limited_results, f, indent=2, ensure_ascii=False)
    print("Raw results saved to airbnb_green_point_limited.json")
