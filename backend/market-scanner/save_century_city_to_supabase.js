...
async function saveAirbnbData() {
    try {
        ...
        const rawData = JSON.parse(fs.readFileSync('airbnb_century_city_limited.json', 'utf8'));
...
async function saveBookingData() {
    try {
        ...
        const rawData = JSON.parse(fs.readFileSync('booking_century_city_raw.json', 'utf8'));
