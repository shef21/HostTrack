...
# Century City coordinates (centered on Canal Walk)
ne_lat = -33.8800  # North-East latitude
ne_long = 18.5100  # North-East longitude
sw_lat = -33.9000  # South-West latitude
sw_long = 18.4900  # South-West longitude
zoom_value = 14  # Zoom level for detailed view

try:
    # Search listings
    print("Searching for listings in Century City...")
    ...
    # Save raw data
    with open('airbnb_century_city_limited.json', 'w', encoding='utf-8') as f:
        json.dump(limited_results, f, indent=2, ensure_ascii=False)
    print("Raw results saved to airbnb_century_city_limited.json")
